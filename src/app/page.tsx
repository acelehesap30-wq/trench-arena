...
export default function Home() {
  ...
  const games = [
    { id: 1, title: "Deep Needle", provider: "TRENCH Originals", img: "https://images.unsplash.com/photo-1640340434855-6084b1f4901c?q=80&w=600", hot: true, link: "/deep-needle" },
    { id: 2, title: "Dead Cat Bounce", provider: "TRENCH Originals", img: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?q=80&w=600", hot: false, link: "/deep-needle" },
    { id: 5, title: "Sweet Bonanza", provider: "Pragmatic Play", img: "https://images.unsplash.com/photo-1518972559570-7cc1309f3229?q=80&w=600", hot: true, link: "/game/sweet-bonanza" },
    { id: 6, title: "Gates of Olympus", provider: "Pragmatic Play", img: "https://images.unsplash.com/photo-1533558701576-23c65e0272fb?q=80&w=600", hot: true, link: "/game/gates-of-olympus" },
    { id: 7, title: "Aviator", provider: "Spribe", img: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?q=80&w=600", hot: true, link: "/game/aviator" },
    { id: 8, title: "Crazy Time", provider: "Evolution", img: "https://images.unsplash.com/photo-1596838132731-3301c3fd4317?q=80&w=600", hot: false, link: "/game/crazy-time" },
    { id: 9, title: "Lightning Roulette", provider: "Evolution", img: "https://images.unsplash.com/photo-1605901309584-818e25960b8f?q=80&w=600", hot: false, link: "/game/lightning-roulette" },
    { id: 10, title: "Sugar Rush", provider: "Pragmatic Play", img: "https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?q=80&w=600", hot: false, link: "/game/sugar-rush" },
  ];
      ...
      <header className="h-20 glass-premium border-b border-white/5 flex items-center justify-between px-6 sticky top-0 z-50">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden xl:flex items-center gap-8 text-sm font-extrabold tracking-wider text-gray-400">
            <Link href="#" className="hover:text-white transition-colors">SPOR</Link>
            <Link href="#" className="hover:text-white transition-colors flex items-center gap-1">CANLI BAHİS <Flame className="w-4 h-4 text-red-500" /></Link>
            <Link href="#" className="text-white border-b-2 border-[#16a34a] pb-7 pt-7">CASINO</Link>
            <Link href="#" className="hover:text-white transition-colors">CANLI CASINO</Link>
          ...
          <div className="space-y-8">
            <div>
              ...
              <ul className="space-y-1.5 text-sm font-bold text-gray-400">
                <li className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/5 cursor-pointer text-white bg-white/10 border-l-4 border-[#16a34a] shadow-[inset_4px_0_0_0_#16a34a]">
                  <Star className="w-5 h-5 text-[#16a34a]" /> Popüler
                </li>
        ...
        <main className="flex-1 p-6 md:p-8 lg:p-12 overflow-hidden relative">
          ...
          <div className="w-full h-[400px] lg:h-[500px] rounded-[32px] mb-12 relative overflow-hidden flex items-center px-10 md:px-20 group shadow-2xl">
            ...
            <div className="relative z-10 max-w-3xl">
              ...
              <div className="flex items-center gap-4">
                <button onClick={() => setIsDepositOpen(true)} className="btn-premium px-10 py-4 text-base shadow-[0_0_30px_rgba(22,163,74,0.3)]">
                  ŞİMDİ OYNA
                </button>
                <button className="px-8 py-4 text-white font-bold text-base hover:bg-white/10 rounded-lg transition-colors flex items-center gap-2">
            ...
            <div className="flex justify-between items-end mb-8">
              <div>
                <h2 className="text-3xl font-black text-white flex items-center gap-3">
                  <Star className="w-8 h-8 text-[#16a34a]" /> EN ÇOK KAZANDIRANLAR
                </h2>
                <p className="text-gray-400 text-sm mt-2 font-medium">Bu hafta en yüksek çarpan veren global slotlar</p>
              </div>
              <button className="hidden sm:flex text-sm text-gray-400 hover:text-white font-bold items-center gap-1 transition-colors">
