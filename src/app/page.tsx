...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <nav className="w-full glass-panel border-b-0 border-x-0 rounded-none px-8 py-4 flex justify-between items-center z-10">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 z-10 w-full max-w-7xl mx-auto mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
          ...
          <div className="glass-panel p-6 rounded-2xl group cursor-pointer hover:border-blue-500/50 transition-all duration-500 hover:-translate-y-1">
          ...
          <div className="glass-panel p-6 rounded-2xl group cursor-pointer hover:border-red-500/50 transition-all duration-500 hover:-translate-y-1">
          ...
          <div className="glass-panel p-6 rounded-2xl group cursor-pointer hover:border-amber-500/50 transition-all duration-500 hover:-translate-y-1">
          ...
          <div className="glass-panel p-6 rounded-2xl group cursor-pointer hover:border-purple-500/50 transition-all duration-500 hover:-translate-y-1">
